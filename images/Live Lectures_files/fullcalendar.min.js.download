...
(function (t) {
    ...
    function A(n, i, r) {
        ...
        return (
            e.isMoment(u)
                ...
                : ((s = !1),
                  (o = !1),
                  d ? (Pe.test(u) ? ((u += "-01"), (n = [u]), (s = !0), (o = !0)) : (l = Ve.exec(u)) && ((s = !l[5]), (o = !0))) : t.isArray(u) && (o = !0),
                  (a = i || s ? e.utc.apply(e, n) : e.apply(null, n)),
                  s ? ((a._ambigTime = !0), (a._ambigZone = !0)) : r && (o ? (a._ambigZone = !0) : d && a.zone(u))),
            (a._fullCalendar = !0),
            a
        );
    }
    ...
    function he(t, e, n) {
        ...
        if (void 0 === t.forwardCoord)
            for (r.length ? (r.sort(pe), he(r[0], e + 1, n), (t.forwardCoord = r[0].backwardCoord)) : (t.forwardCoord = 1), t.backwardCoord = t.forwardCoord - (t.forwardCoord - n) / (e + 1), i = 0; r.length > i; i++)
    ...
    function me(n, r) {
        ...
        function h(e, n) {
            pe++,
                ...
                le &&
                    (0 > e ? (de = le.computePrevDate(de)) : e > 0 && (de = le.computeNextDate(de)),
                    (le.start && !e && de.isWithin(le.intervalStart, le.intervalEnd)) || (d() && (j(), le.start && le.destroyView(), le.setDate(de), le.renderView(), X(), F(), z(), H()))),
                X(),
                pe--;
        }
        function f(t) {
            ...
            return (
                ...
                s
                    ? ((l = r.duration || s.duration),
                      l && ((l = e.duration(l)), (a = b(l)), (p = 1 === D(a, l))),
                      p && h[a] && (r = t.extend({}, h[a], r)),
                      (u = c[n] || (p ? c[a] : null) || d[n] || (p ? d[a] : null) || r.buttonText || s.buttonText || (l ? o(l) : null) || n),
                      (ge[n] = { class: s, options: r, buttonText: u }))
                    : void 0
            );
        }
        function p(t) {
        ...
        function w() {
            ae = "number" == typeof te.contentHeight ? te.contentHeight : "number" == typeof te.height ? te.height - (re ? re.outerHeight(!0) : 0) : Math.round(se.width() / Math.max(te.aspectRatio, 0.5));
        }
        function E(t) {
        ...
        function L(t, e) {
            (t = Q.moment(t)), (e = e ? Q.moment(e) : t.hasTime() ? t.clone().add(Q.defaultTimedEventDuration) : t.clone().add(Q.defaultAllDayEventDuration)), le.select({ start: t, end: e });
        }
        function V() {
            le && le.unselect();
        }
        ...
        var ee = x(s(te.lang));
        if (
            (te.monthNames && (ee._months = te.monthNames),
            te.monthNamesShort && (ee._monthsShort = te.monthNamesShort),
            te.dayNames && (ee._weekdays = te.dayNames),
            te.dayNamesShort && (ee._weekdaysShort = te.dayNamesShort),
            null != te.firstDay)
        ) {
            var ne = x(ee._week);
        ...
        (Q.defaultAllDayEventDuration = e.duration(te.defaultAllDayEventDuration)),
            ...
            (Q.moment = function () {
                var t;
                return (
                    "local" === te.timezone ? ((t = De.moment.apply(null, arguments)), t.hasTime() && t.local()) : (t = "UTC" === te.timezone ? De.moment.utc.apply(null, arguments) : De.moment.parseZone.apply(null, arguments)),
                            ...
                            "title" == r
                                ...
                                : (e[r]
                                  ...
                                  l &&
                                      ...
                                      (h = w(n.buttonText, r)),
                                      (g = c || h ? z(c || h) : a && n.theme ? "<span class='ui-icon ui-icon-" + a + "'></span>" : u && !n.theme ? "<span class='fc-icon fc-icon-" + u + "'></span>" : z(d || r)),
                                      (m = ["fc-" + r + "-button", f + "-button", f + "-state-default"]),
                                      (v = t('<button type="button" class="' + m.join(" ") + '">' + g + "</button>")
                                          .click(function () {
    ...
    function ye(n) {
        ...
        function m(e) {
            ...
            for (
                ...
                t.isArray($[i].events) && ($[i].events = t.grep($[i].events, e, !0));
            j(Q);
        }
        function v(e) {
        ...
        function b(i, r) {
            ...
            if (
                ...
                (a.start = s ? e.duration(s) : null), (a.end = o ? e.duration(o) : null), (a._recurring = !0);
            else {
        ...
        function x(t) {
            var e;
            return t.end || ((e = t.allDay), null == e && (e = !t.start.hasTime()), (t = { start: t.start, end: O.getDefaultEventEnd(e, t.start) })), t;
        }
        function H(e, n, i) {
            var r,
                s,
            ...
            if (((n = n || B), (i = i || Z), e))
                if (e._recurring) {
                    ...
                    for (l = n.clone().stripTime(); l.isBefore(i); )
                        (!r || r[l.day()]) && ((a = e.start), (u = e.end), (d = l.clone()), (c = null), a && (d = d.time(a)), u && (c = l.clone().time(u)), (h = t.extend({}, e)), D(d, c, !a && !u, h), f.push(h)), l.add(1, "days");
                } else f.push(e);
            return f;
        }
        function R(e, n) {
            ...
            return (
                ...
                t.each(e, function (e, u) {
                    ...
                    (d = { start: u.start.clone(), end: u.end ? u.end.clone() : null, allDay: u.allDay }),
                        ...
                        (c = { start: u._start, end: u._end, allDay: u._allDay }),
                        n && (c.end = null),
                        (c.allDay = i),
                        C(c),
    ...
    var Ee = {
            ...
            timezone: !1,
            isRTL: !1,
            defaultButtonText: { prev: "prev", next: "next", prevYear: "prev year", nextYear: "next year", today: "today", month: "month", week: "week", day: "day" },
        ...
        (_e.isSame = function (t, e) {
            ...
            return this._fullCalendar
                ? e
                    ...
                    : ((t = De.moment.parseZone(t)), Ge.isSame.call(this, t) && Boolean(this._ambigTime) === Boolean(t._ambigTime) && Boolean(this._ambigZone) === Boolean(t._ambigZone))
    ...
    var Oe = K.extend({
        ...
        Ie = K.extend({
            ...
            startListening: function (e) {
                ...
                this.isListening ||
                    (e &&
                        this.options.scroll &&
                        ((n = p(t(e.target))), n.is(window) || n.is(document) || ((this.scrollEl = n), (this.scrollHandlerProxy = G(t.proxy(this, "scrollHandler"), 100)), this.scrollEl.on("scroll", this.scrollHandlerProxy))),
                    this.computeCoords(),
                    e && ((i = this.getCell(e)), (this.origCell = i), (this.mouseX0 = e.pageX), (this.mouseY0 = e.pageY)),
                    t(document)
            ...
            dragScroll: function (t) {
                ...
                o &&
                    ...
                    e >= 0 && 1 >= e ? (l = -1 * e * this.scrollSpeed) : n >= 0 && 1 >= n && (l = n * this.scrollSpeed),
                    i >= 0 && 1 >= i ? (a = -1 * i * this.scrollSpeed) : r >= 0 && 1 >= r && (a = r * this.scrollSpeed)),
        ...
        We = K.extend({
            ...
            stop: function (e, n) {
                ...
                this.isFollowing &&
                    ...
                    e && s && !this.isHidden ? ((this.isAnimating = !0), this.el.animate({ top: this.top0, left: this.left0 }, { duration: s, complete: i })) : i());
            },
            getEl: function () {
                var t = this.el;
                return (
        ...
        Xe = (De.Grid = je.extend({
            ...
            getCell: function (e, n) {
                var i;
                return (
                    null == n && ("number" == typeof e ? ((n = e % this.colCnt), (e = Math.floor(e / this.colCnt))) : ((n = e.col), (e = e.row))),
                    (i = { row: e, col: n }),
            ...
            computeSelection: function (t, e) {
                ...
                return i.sort(V), (n = { start: i[0].clone(), end: i[3].clone() }), this.view.calendar.isSelectionRangeAllowed(n) ? n : null;
            },
    ...
    Xe.mixin({
        ...
        computeEventDrop: function (t, e, n) {
            var i,
                ...
                u = e.start;
            return (
                a.hasTime() === u.hasTime() ? ((i = E(u, a)), (r = n.start.clone().add(i)), (s = null === n.end ? null : n.end.clone().add(i)), (o = n.allDay)) : ((r = u.clone()), (s = null), (o = !u.hasTime())),
            ...
            (r = new Ie(this.coordMap, {
                ...
                cellOver: function (e) {
                    (i = e.end),
                        ...
                        i.isSame(f) ? (i = null) : l.isEventRangeAllowed({ start: h, end: i }, c) ? (s.renderEventResize({ start: h, end: i }, t), o.hideEvent(c)) : ((i = null), a());
                },
                cellOut: function () {
                    (i = null), n();
                },
        ...
        eventsToInverseRanges: function (t) {
            var e,
                ...
                a = t[0],
                u = r;
            for (o.sort(ie), e = 0; o.length > e; e++) (n = o[e]), n.start > u && l.push({ event: a, start: u, end: n.start }), (u = n.end);
    ...
    var $e = Xe.extend({
        ...
        dayRowHtml: function (t, e) {
            ...
            return (
                ...
                '<div class="' +
                    ...
                    "<table>" +
                    (this.numbersVisible ? "<thead>" + this.rowHtml("number", t) + "</thead>" : "") +
                    "</table>" +
                    "</div>" +
                    "</div>"
            );
        ...
        updateCellDates: function () {
            for (var t = this.view, e = this.start.clone(), n = [], i = -1, r = []; e.isBefore(this.end); ) t.isHiddenDay(e) ? r.push(i + 0.5) : (i++, r.push(i), n.push(e.clone())), e.add(1, "days");
        ...
        rangeToSegs: function (t) {
            ...
            for (t = this.view.computeDayRange(t), e = this.dateToCellOffset(t.start), n = this.dateToCellOffset(t.end.subtract(1, "days")), i = 0; h > i; i++)
                (r = i * f),
                    ...
                    (a = Math.ceil(a)),
                    (u = Math.floor(u)),
                    u >= a && ((o = a === e), (l = u === n), (a -= r), (u -= r), (d = { row: i, isStart: o, isEnd: l }), c ? ((d.leftCol = f - u - 1), (d.rightCol = f - a - 1)) : ((d.leftCol = a), (d.rightCol = u)), g.push(d));
            return g;
        },
        ...
        renderFillRow: function (e, n) {
            var i,
                ...
                l = n.rightCol + 1;
            return (
                (i = t('<div class="fc-' + e.toLowerCase() + '-skeleton">' + "<table><tr/></table>" + "</div>")),
                (r = i.find("tr")),
            ...
            for (r = 0; f > r; r++) {
                if (((s = h[r]), (o = 0), (l = t("<tr/>")), p.push([]), m.push([]), v.push([]), s))
                    for (a = 0; s.length > a; a++) {
                        for (u = s[a], i(u.leftCol), d = t('<td class="fc-event-container"/>').append(u.el), u.leftCol != u.rightCol ? d.attr("colspan", u.rightCol - u.leftCol + 1) : (v[r][o] = d); u.rightCol >= o; )
                            (m[r][o] = d), (p[r][o] = u), o++;
                        l.append(d);
                    }
            ...
            renderMoreLink: function (e, n) {
                ...
                return t('<a class="fc-more"/>')
                    ...
                    .on("click", function (s) {
                        ...
                        "function" == typeof o && (o = r.trigger("eventLimitClick", null, { date: l, dayEl: u, moreEl: a, segs: c, hiddenSegs: h }, s)),
    ...
    var Ue = Xe.extend({
        ...
        rangeToSegs: function (t) {
            var e,
                ...
                s = this.colCnt,
                o = [];
            for (t = { start: t.start.clone().stripZone(), end: t.end.clone().stripZone() }, n = 0; s > n; n++)
                (i = this.colData[n].day), (r = { start: i.clone().time(this.minTime), end: i.clone().time(this.maxTime) }), (e = y(t, r)), e && ((e.col = n), o.push(e));
            return o;
        },
        resize: function () {
            ...
            if (n.length) {
                for (n = this.renderFillSegEls(e, n), r = this.groupSegCols(n), i = i || e.toLowerCase(), s = t('<div class="fc-' + i + '-skeleton">' + "<table><tr/></table>" + "</div>"), o = s.find("tr"), l = 0; r.length > l; l++)
                    if (((a = r[l]), (u = t("<td/>").appendTo(o)), a.length))
                        for (d = t('<div class="fc-' + i + '-container"/>').appendTo(u), c = this.colData[l].day, h = 0; a.length > h; h++)
                            (f = a[h]), d.append(f.el.css({ top: this.computeDateTop(f.start, c), bottom: -this.computeDateTop(f.end, c) }));
    ...
    Ue.mixin({
        ...
        fgSegHtml: function (t, e) {
            ...
            return (
                ...
                s.isMultiDayEvent(o)
                    ? (t.isStart || t.isEnd) && ((n = this.getEventTimeText(t)), (i = this.getEventTimeText(t, "LT")), (r = this.getEventTimeText({ start: t.start })))
                    : ((n = this.getEventTimeText(o)), (i = this.getEventTimeText(o, "LT")), (r = this.getEventTimeText({ start: o.start }))),
                '<a class="' +
                    u.join(" ") +
                    '"' +
                    (o.url ? ' href="' + z(o.url) + '"' : "") +
                    ...
                    ">" +
                    '<div class="fc-content">' +
                    (n ? '<div class="fc-time" data-start="' + z(r) + '"' + ' data-full="' + z(i) + '"' + ">" + "<span>" + z(n) + "</span>" + "</div>" : "") +
                    (o.title ? '<div class="fc-title">' + z(o.title) + "</div>" : "") +
                    "</div>" +
                    '<div class="fc-bg"/>' +
    ...
    var qe = (De.View = K.extend({
        ...
        computeRange: function (t) {
            var n,
                i,
                r = e.duration(this.opt("duration") || this.constructor.duration || { days: 1 }),
                s = b(r),
                o = t.clone().startOf(s),
                l = o.clone().add(r);
            return (
                D("days", r) ? (o.stripTime(), l.stripTime()) : (o.hasTime() || (o = this.calendar.rezoneDate(o)), l.hasTime() || (l = this.calendar.rezoneDate(l))),
                (n = o.clone()),
                (n = this.skipHiddenDays(n)),
                (i = l.clone()),
                (i = this.skipHiddenDays(i, -1, !0)),
                { intervalDuration: r, intervalUnit: s, intervalStart: o, intervalEnd: l, start: n, end: i }
            );
        },
        ...
        computeScrollerHeight: function (t, e) {
            var n, i;
            return (e = e || this.scrollerEl), (n = this.el.add(e)), n.css({ position: "relative", left: -1 }), (i = this.el.outerHeight() - e.height()), n.css({ position: "", left: "" }), t - i;
        },
    ...
    (tn.duration = { months: 1 }),
        ...
        n({ allDaySlot: !0, allDayText: "all-day", scrollTime: "06:00:00", slotDuration: "00:30:00", minTime: "00:00:00", maxTime: "24:00:00", slotEventOverlap: !0 });
    var en = 5;
    (Ce.agenda = qe.extend({
        timeGrid: null,
        dayGrid: null,
        ...
        renderHtml: function () {
            return (
                ...
                this.widgetContentClass +
                '">' +
                (this.dayGrid ? '<div class="fc-day-grid"/><hr class="' + this.widgetHeaderClass + '"/>' : "") +
        ...
        headIntroHtml: function () {
            ...
            return this.opt("weekNumbers")
                ? ((t = this.timeGrid.getCell(0).start),
                  ...
                  '<th class="fc-axis fc-week-number ' + this.widgetHeaderClass + '" ' + this.axisStyleAttr() + ">" + "<span>" + z(i) + "</span>" + "</th>")
        ...
        setHeight: function (t, e) {
            ...
            null === this.bottomRuleHeight && (this.bottomRuleHeight = this.bottomRuleEl.outerHeight()),
                ...
                e ||
                    ...
                    f(this.scrollerEl, i)
                        ? (o(this.noScrollRowEls, m(this.scrollerEl)), (i = this.computeScrollerHeight(t)), this.scrollerEl.height(i), this.restoreScroll())
